...
import { ArrowRight, Check, ChevronRight, Cog, Gauge, Sparkles } from "lucide-react"
    ...
    },
    {
      ...
      protocols: [
        ...
        },
        {
          ...
          apy: 8.1,
          risk: "high",
          features: ["Yield optimization", "Auto-compounding", "Strategy vaults"],
        },
      ],
    },
    {
    ...
    <section ref={ref} className="py-20 lg:py-32">
      <div className="container mx-auto px-4">
        <div className="mb-12 text-center">
          ...
          >
            Discover the highest yields across multiple protocols with our advanced optimization engine
          </motion.p>
        </div>
                  ...
                  >
                    <Card
                      className={cn(
                        ...
                        selectedAsset === asset.id ? "border-blue-500 bg-blue-500/5" : "",
                      )}
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <ChevronRight
                            className={cn(
                              ...
                              selectedAsset === asset.id ? "rotate-90 text-blue-500" : "",
                            )}
                          />
                        </div>
                      </CardHeader>
            ...
            >
              {!selectedAsset ? (
                <div className="flex h-full flex-col items-center justify-center rounded-xl border border-dashed border-slate-700 p-8 text-center">
                  ...
                  <h3 className="mb-2 text-xl font-medium">Select an Asset to Optimize</h3>
                  <p className="text-slate-400">
                    Choose an asset from the left to discover the highest yield opportunities
                  </p>
                </div>
              ) : (
                  ...
                  <div className="border-b border-slate-800 p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h3 className="text-xl font-medium">{selectedAssetData?.name} Optimization</h3>
                          <p className="text-sm text-slate-400">Finding the best yield strategies</p>
                        </div>
                      </div>
                    ...
                    {isOptimizing && (
                      <div className="mt-4">
                        ...
                        <div className="mt-2 flex items-center space-x-2 text-xs text-slate-400">
                          ...
                          <span>Scanning {selectedAssetData?.protocols.length} protocols for best yields</span>
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="p-4">
                    {isOptimized ? (
                      <div className="relative">
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-slate-300">
                                  We've found the optimal strategy for your {selectedAssetData?.name}
                                </p>
                              </div>
                            </div>
                            <div className="text-right">
                              ...
                              <p className="text-2xl font-bold text-green-500">
                                {(Math.max(...(selectedAssetData?.protocols.map((p) => p.apy) || [0])) * 1.1).toFixed(
                                  1,
                                )}
                                %
                              </p>
                        ...
                        <div className="mb-6">
                          <h4 className="mb-3 font-medium">Optimized Strategy</h4>
                                ...
                                .map((protocol, index) => (
                                  <motion.div
                                    ...
                                    className={cn(
                                      ...
                                      index === 0 ? "bg-blue-500/20 ring-1 ring-blue-500/30" : "bg-slate-700/50",
                                    )}
                                  >
                                    <div className="font-medium">{protocol.name}</div>
                                    <div>{index === 0 ? "70%" : index === 1 ? "30%" : "0%"}</div>
                                    <div className={index === 0 ? "font-bold text-green-500" : "text-slate-300"}>
                        ...
                        >
                          ...
                          <div className="mb-6 rounded-lg border border-slate-800 bg-slate-800/50 p-4">
                            ...
                            <div className="mt-2 text-center text-sm">
                              This strategy has a <span className="font-medium text-yellow-400">medium</span> risk
                              profile
                            </div>
                          </div>

                          <Button className="w-full bg-blue-600 hover:bg-blue-700">
                            Apply Optimized Strategy <ArrowRight className="ml-2 h-4 w-4" />
                          </Button>
                        </motion.div>
                      </div>
                    ) : !isOptimizing ? (
                      <div>
                        <h4 className="mb-3 font-medium">Available Protocols for {selectedAssetData?.name}</h4>
                        <div className="space-y-3">
                          {selectedAssetData?.protocols.map((protocol, index) => (
                            <motion.div
                              key={protocol.id}
                              initial={{ opacity: 0, y: 10 }}
                              animate={{ opacity: 1, y: 0 }}
                            ...
                            >
                              <div className="mb-3 flex items-center justify-between">
                                <div className="flex items-center space-x-3">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-xs text-slate-400">Protocol for {selectedAssetData?.name}</p>
                                  </div>
                                </div>
                                <div className="text-right">
                              ...
                              <div className="mb-3 flex flex-wrap gap-2">
                                {protocol.features.map((feature, i) => (
                                  <span key={i} className="rounded-full bg-slate-700 px-2 py-1 text-xs text-slate-300">
                                    {feature}
                                  </span>
                                ))}
                              </div>
                        ...
                        <div className="mt-6 flex justify-center">
                          <Button onClick={handleOptimize} size="lg" className="bg-blue-600 hover:bg-blue-700">
                      ...
                      <div className="flex h-64 flex-col items-center justify-center">
                        ...
                        <h4 className="mb-2 text-lg font-medium">Optimizing Your Strategy</h4>
                        <p className="text-center text-slate-400">
                          Our AI is analyzing {selectedAssetData?.protocols.length} protocols to find the best yield
                          strategy for your {selectedAssetData?.name}
                        </p>
                      </div>
                    )}
                  </div>
