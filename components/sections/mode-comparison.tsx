      ...
      <div className="px-4">
        <div className="mb-8 lg:mb-12 text-center">
          ...
          <motion.p
            ...
            className="mx-auto text-base sm:text-lg text-slate-300 max-w-2xl"
          >
          ...
          >
            <div className="p-4 sm:p-6">
              <div className="mb-6 flex items-center">
                ...
                <div>
                  <h3 className="text-xl sm:text-2xl font-bold">Agent Mode</h3>
                  <p className="text-sm sm:text-base text-slate-400">
              ...
              <div className="space-y-4">
                <div className="rounded-lg bg-slate-800 p-4">
                  ...
                  <p className="text-sm text-slate-300">
                    ...
                    automatically optimizes your portfolio for maximum returns
                    while managing risk.
                  </p>
                </div>
                ...
                <div className="rounded-lg bg-slate-800 p-4">
                  ...
                  <ul className="space-y-2 text-sm text-slate-300">
                    <li className="flex items-start">
                      ...
                      <span>Busy professionals who want passive income</span>
                    </li>
                    <li className="flex items-start">
                      <Check className="mr-2 h-4 w-4 text-purple-500" />
                      <span>Newcomers to DeFi</span>
                    </li>
                    <li className="flex items-start">
                      <Check className="mr-2 h-4 w-4 text-purple-500" />
                      <span>
                        Those who want maximum returns with minimal effort
                      </span>
                    </li>
                  </ul>
                </div>
